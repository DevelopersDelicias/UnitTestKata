...
public class SpanishNumberNameTest {
	...
	private Object parametersForCan_say_its_name() {
		return new Object[][]{
				...
				number(2000, "Dos mil"),
				number(2018, "Dos mil dieciocho"),
				number(3000, "Tres mil"),
				number(3523, "Tres mil quinientos veintitrés"),
				number(4000, "Cuatro mil"),
				number(4199, "Cuatro mil ciento noventa y nueve"),
				number(5000, "Cinco mil"),
				number(5008, "Cinco mil ocho"),
				number(6000, "Seis mil"),
				number(6025, "Seis mil veinticinco"),
				number(7000, "Siete mil"),
				number(7100, "Siete mil cien"),
				number(8000, "Ocho mil"),
				number(8888, "Ocho mil ochocientos ochenta y ocho"),
				number(9000, "Nueve mil"),
				number(10_000, "Diez mil"),
				number(10_010, "Diez mil diez"),
				number(100_000, "Cien mil"),
				number(100_001, "Cien mil uno"),
				number(111_111, "Ciento once mil ciento once"),
				number(150_150, "Ciento cincuenta mil ciento cincuenta"),
				...
				number(1_000_001, "Un millón uno"),
				number(1_100_100, "Un millón cien mil cien"),
				number(2_000_000, "Dos millones"),
				number(3_000_000, "Tres millones"),
				number(5_050_005, "Cinco millones cincuenta mil cinco"),
				number(9_999_999, "Nueve millones novecientos noventa y nueve mil novecientos noventa y nueve"),
				...
				number(999_999_999_999L, "Novecientos noventa y nueve mil novecientos noventa y nueve millones " +
